class YourControlsNetwork {
    ...
    connectWebsocket() {
        ...
        this.socket.addEventListener('close', this.lostConnection.bind(this));
        this.socket.addEventListener('error', this.lostConnection.bind(this));
    ...
    startAttemptConnection(instrumentName) {
        ...
        setInterval(this.attemptConnection.bind(this), 3000)
    }
